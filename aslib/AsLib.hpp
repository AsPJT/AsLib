...
//AsLibバージョン
constexpr int32_t ASLIB_VERSION = 0x0110;
const char* ASLIB_VERSION_STR = "0.1.1.0 Alpha";

//AsLibバージョン (UTF)
const char* ASLIB_VERSION_STR8 = u8"0.1.1.0 Alpha";
const char16_t* ASLIB_VERSION_STR16 = u"0.1.1.0 Alpha";
const char32_t* ASLIB_VERSION_STR32 = U"0.1.1.0 Alpha";
