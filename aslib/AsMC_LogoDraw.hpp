...
namespace AsLib
{
	...
	inline MainControl& MainControl::logoTex(const size_t add_texture_id, const int32_t add_in_time, const int32_t add_out_time, const int32_t add_time, const size_t add_scene)
	{
		static int32_t time_counter = 0;
		time_counter += time_counter_ms / this->fps;
