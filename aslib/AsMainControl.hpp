...
namespace AsLib
{
	...
	public:
		MainControl(const char* const title_="AsLib", const Pos2& window_size_ = aslib_default_window_size, const Color& c_ = aslib_bg_color) :window_size(asWindowSizeSave(true,window_size_)), color(c_), title_name(title_)
		{
			//OF例外措置
